<template>
  <div class="playing-list" id="playing-song-list">
    <div class="top-nav">
      <tabBar @switchTab="changeTabSwitch" :tabItem="tabitems"></tabBar>
    </div>
    <!-- 播放列表 -->
...
import { getSongUrl, checkSong } from "@/axiosReq/playmusic/playmusic.js"
...
export default {
  ...
  mounted() {
		...
		let playingListDOM = document.querySelector("#playing-song-list");
		// let footerDOM = document.querySelector("#footer");
		document.addEventListener("mousedown", e => {
			if (playingListDOM) {
				if (!playingListDOM.contains(e.target)) {
