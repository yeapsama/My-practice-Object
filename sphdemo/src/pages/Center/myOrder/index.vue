<template>
  <div class="order-right">
         ...
         <Pagination :pageNo="pageNo" :pageSize="limit" :totalData="myOrderInfo.total" :continues="5" @getPageNum="getPageNum"/>
...
export default {
    ...
    methods:{
     async getData(){
      let result =  await this.$API.reqMyOrder(this.pageNo,this.limit);
      if(result.code == 200){
